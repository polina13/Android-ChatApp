...
public class LoginAccountActivity extends AppCompatActivity implements View.OnClickListener {
    public static final String TAG = LoginAccountActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSharedPreferences = PreferenceManager.getDefaultSharedPreferences(LoginAccountActivity.this);
    ...
    public void loginWithPassword() {
        ...
        mFirebaseRef.authWithPassword(email, password, new Firebase.AuthResultHandler() {
            ...
            private void showErrorToast(String message) {
                Toast.makeText(LoginAccountActivity.this, message, Toast.LENGTH_LONG).show();
